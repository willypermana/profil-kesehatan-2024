...
berkasData = currentdir +'\\bab_06_17g_dataVaksinCovidDos2.csv'
berkasSimpan = currentdir +'\\bab_06_17g_vaksinCovidDos2.pdf'
# judulDiagram = 'Cakupan Vaksin COVID-19 Dosis 2\nTahun 2022'
sumbuX = 'Cakupan Vaksin COVID-19 Dosis 2'
