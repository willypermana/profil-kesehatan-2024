...
berkasData = currentdir +'\\bab_06_17a_dataKasusCovid.csv'
berkasSimpan = currentdir +'\\bab_06_17a_kasusCovid.pdf'
# judulDiagram = 'Jumlah Kasus COVID-19\nTahun 2022'
sumbuX = 'Jumlah'
sumbuY = 'Puskesmas/ Luar Daerah/ Kabupaten'
tickerSumbuX = np.arange(0,11,5)
labelBar1 = 'Kasus COVID-19'

# read data file
colnames = ['puskesmas','kasusCOVID19']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.kasusCOVID19.tolist()
