...
berkasData = currentdir +'\\bab_06_17e_dataKasusCovidPerJK.csv'
berkasSimpan = currentdir +'\\bab_06_17e_kasusCovidPerJK.pdf'
...
# read data file
colnames = ['puskesmas','kasusL','kasusP']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.kasusL.tolist()
bar2 = data.kasusP.tolist()
